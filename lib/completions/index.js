...
const state = {
    ...
    dirComplete: function dirComplete(start, tokens, cb, opts) {
        ...
        if (tok.cursor.token === 0) {
            ...
            if (data.end > 0) {
                ...
                case '.':
                    ...
                    state.dirComplete(data.start, tok, cb, { cmp: direxe, cache: state.direxecache });
                    return;
                default:
                    break;
                }
        ...
        setImmediate(() => {
            ...
            let comp = function*() {
                ...
                if (!completed) {
                    ...
                    state.dirComplete(data.start, tok, cb, { cmp: check, rel: relpaths, cache: state.dirrelcache });
                }
